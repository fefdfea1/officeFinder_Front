...
export const Join = () => {
  ...
  return (
    <>
      <input type="text" />
      {step === 0 && (
        <div className="shadow-md rounded-xl p-8 w-[400px] h-[400px] mx-auto my-4 flex items-center justify-items-center">
          <div className="flex-col items-center">
            <Button
              clickHandler={() => clickCard('customer')}
              text="일반 회원 회원가입"
              style={'btn btn-outline btn-primary w-72 m-2 text-base'}
            ></Button>
            <Button
              clickHandler={() => clickCard('agency')}
              text="임대인 회원가입"
              style={'btn btn-outline btn-primary w-72 m-2 text-base'}
            ></Button>
          </div>
